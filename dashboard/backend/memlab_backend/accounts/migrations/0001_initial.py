    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_type', models.CharField(choices=[('A', 'Free'), ('B', 'Premium')], default='A', max_length=1)),
                ('license_modified_at', models.DateTimeField(default=django.utils.timezone.now)),
